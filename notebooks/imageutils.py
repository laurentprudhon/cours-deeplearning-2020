...
def filter_images(path:Path, img_type:str='JPEG')->int:
...
def image_download(search_text:str, num_images:int, label:str=None, engine:str="bing", image_dir:Path=Path.cwd(), apikey=None):
    """
